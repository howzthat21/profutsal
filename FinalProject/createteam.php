...
<head>
  ...
  <title>Create a Team - Futsal Matchmaking</title>
...
<body>
  ...
  <div class="create-team-page">
    ...
    <section class="title-section">
      <h2>Create a Team</h2>
      <p>Set up your team and prepare for a match at your favorite arena!</p>
    </section>
    ...
    <form class="team-form">
      ...
      <div class="form-group">
        ...
        <select id="arena_name" name="arena_name" required>
          <option value="">Select Arena</option>
          <option value="Super Futsal Arena">Super Futsal Arena</option>
          <option value="Elite Futsal Hub">Elite Futsal Hub</option>
        </select>
      </div>
  ...
  <script>
    function initMap() {
      // Initial map setup (if needed in the future)
    }
  </script>
</body>
</html>
