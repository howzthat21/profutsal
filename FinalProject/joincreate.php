...
<head>
  ...
  <title>Futsal Matchmaking - Team Options</title>
...
<body>
  ...
  <div class="landing-page">
    ...
    <!-- Introduction section with options to Join or Create a Team -->
    <section class="main-content">
      <h2>Welcome Back to Futsal Matchmaking!</h2>
      <p>
        Ready to join a team or create your own? Connect with players who match your skill level and availability to play exciting futsal matches.
      </p>
